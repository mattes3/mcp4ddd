...
- **Aggregate Support in Services**: Added aggregateName parameter to service generation, enabling automatic generation of transaction-based services with proper error handling and repository integration
